...
figure(1),subplot(2,1,1), image(RGB);             % Display the original image
title('Origianl BMP Image'); 
figure(2), subplot(2,1,1),imhist(RGB); 
...
figure(1),subplot(2,1,2),image(RGBgamma);       % Display gamma corrected image 
title('Gamma Corrected RGB Image');

figure(2), subplot(2,1,2),imhist(RGBgamma); 
title('Histogram of gamma image');
